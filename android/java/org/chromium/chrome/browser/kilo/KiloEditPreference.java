...
public class KiloEditPreference extends Preference {

    private static final String TAG = "KiloEditPreference";

    public KiloEditPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void showInputDialog() {
        ...
        String currentGateway = factory.getIpfsGateWay();
        if (currentGateway == null) currentGateway = "now the gateway is null";

        Log.d(TAG, "get gateway: " + currentGateway);

        TextInputLayout inputLayout = new TextInputLayout(context);
        inputLayout.setHint("Set IPFS gateway");
    ...
    private void onValueSaved(String value) {
        ...
        factory.setIpfsGateWay(value);
        setSummary(value);
        Log.d(TAG, "Saved IPFS gateway: " + value);
    }
